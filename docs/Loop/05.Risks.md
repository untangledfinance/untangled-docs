...
**Important:** money market liquidations can be harsh. Avoid running positions near the edge.
...
- reduce carry收益 (or flip it negative)
- accelerate liquidation risk

## 5) Smart contract risk
You are exposed to multiple layers:
- Untangled Loop contracts (Entrypoint + MarginManager)
...
- spot liquidity can vanish
- money markets can reprice sharply
- liquidation cascades can occur

This is not controllable at the app level.
